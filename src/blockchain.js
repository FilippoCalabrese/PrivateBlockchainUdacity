...
class Blockchain {
    ...
    requestMessageOwnershipVerification(address) {
        return new Promise((resolve) => {
            //creating a simple verification message hashing the address and concatenating current timestamp
    ...
    /**
     * The diffMinutesFromNow(timestamp) method
     * is used to calculate difference in minute from a given timestamp
     * to the actual timestamp
     * @param integer timestamp 
     */
    diffMinutesFromNow(timestamp) 
    {
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            //2
            const timestampsDistanceInMinutes = this.diffMinutesFromNow(messageTime);
    ...
    async retriveInformations(block) { 
        return block.getBData().then((result) => {data = result})
    }
